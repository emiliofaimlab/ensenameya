 ...
 *
 *  ⚠️ Exportada desde el paquete de edición: el gestor calcula el aviso de
 *  solape EN CLIENTE con esta misma función. Antes salía solo de
 *  `buildSlotPreview`, que es de servidor y que el paso 4 del asistente no
 *  recibe (no hay mentorías todavía) — o sea que en el onboarding, que es donde
 *  el tutor escribe sus franjas por primera vez, no se avisaba de nada. */
