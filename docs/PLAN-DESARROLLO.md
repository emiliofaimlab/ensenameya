...
- [~] **EP-06 / EP-07** Reserva · Checkout · Pagos (núcleo del dinero, PSP simulado)
  ...
  - [ ] **US-602 + US-701/702** checkout simulado (RPC `create_booking`/`confirm_payment`; routing + split snapshot)
  - [ ] **US-606 + US-603** aceptar/rechazar 24h (`pending_acceptance`, RN-38) + confirmación
  - [ ] **US-604 / US-605 / US-607 / US-703 / US-705** cancelar+reembolso (RN-37) · autocancelar 20 min · card-on-file · idempotencia · adaptador
- [ ] **EP-07** (integrado arriba con EP-06; US-704 reembolso manual admin → S3)
